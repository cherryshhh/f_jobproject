...
#os.environ["KMP_DUOLICATE_LIB_OK"] = "TRUE"
...
def get_conversational_chain(tools, ques):
    ...
    print(response)
    st.write("AI 回答: ", response['output'])
...
def user_input(user_question):
    if not check_database_exists():
        st.error("wrong! 请先上传PDF文件并点击'Submit & Process'按钮来处理文档!")
...
def main():
    st.set_page_config("🤖 langchain agent")
    st.header("🤖 langchain agent")
